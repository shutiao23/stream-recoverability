...
CORPUS_SCHEMA_VERSION = "t2_v91_open_role_mh_corpus_acquisition_v2_6"
NETWORK_SCHEMA_VERSION = "t2_v91_open_role_mh_network_acquisition_v2_6"
...
V2_5_NETWORK_SCHEMA_VERSION = "t2_v91_open_role_mh_network_acquisition_v2_5"
...
PLAN_SCHEMA_VERSION = "t2_v91_open_role_mh_corpus_request_plan_v2_6"
PARSER_CONTRACT_VERSION = "legacy_nwis_rdb_hydraulics_parser_v2_6"
...
LEGACY_EMPTY_NO_SITES_RDB = (
    b"#  No sites found matching all criteria\n"
...
def parse_legacy_hydraulics_rdb(
    ...
    *,
    ...
    if payload == LEGACY_EMPTY_NO_SITES_RDB:
        return pd.DataFrame()
...
def _archive_reason(output: Path) -> str:
    ...
    if manifest.get("status") in TERMINAL_STATUSES:
        if manifest.get("manifest_schema") in STALE_NETWORK_SCHEMA_VERSIONS:
            return "terminal_rebuild_parser_contract_v2_6"
...
def _complete_attempt_archive(
    ...
    *,
    ...
    archive_manifest = {
        "manifest_schema": "t2_v91_open_role_mh_attempt_archive_v2_6",
        "attempt_number": number,
        "network_id": network.network_id,
        "role": network.role,
        "network_plan_sha256": network.network_plan_sha256,
    ...
    *,
    ...
    if execute:
        ...
        _write_json_atomic(
            root_state_path,
            {
                "manifest_schema": "t2_v91_open_role_mh_root_execution_state_v2_6",
                "status": "in_progress",
