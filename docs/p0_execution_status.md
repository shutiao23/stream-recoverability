...
| P0-07 | Complete | Dual frontiers, donor-C effects/decision, resilience, events, and three sensitivity aggregates pass the analysis gate. |
| P0-08 | Complete | External feasibility passed 60/60 without training, scoring, or a once-lock. |
| P0-09 | Deliberately unopened | Evaluate-once recovery performance remains reserved; train-only external prediction is complete. |
...
| P0-12 | Pending final submission audit | Formal evidence now exists; the submission gate is rerun after manuscript synchronization. |
