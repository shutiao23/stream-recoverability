...
| P0-11 | Complete | No RESULTS_PENDING marker remains; manuscript, SI, Key Points, PLS, figures, tables, rights, and evidence ledgers are synchronized. |
| P0-12 | NO-GO on release compliance | Scientific evidence is complete. Restricted public history and the absent archival DOI still block submission. |
