---
title: "A Case-Study Covariance Heuristic for Stream-Temperature Recoverability in Two Regulated River Networks"
author:
...
Reservoir releases can compress downstream thermal seasonality and extend persistence, but those changes are rarely connected to information for reconstructing monitoring outages. We treat controlled gaps as an observational probe of that connection rather than as a model leaderboard or a causal reservoir experiment. A train-only covariance heuristic separates simultaneous donor anomalies from local boundary memory at three Jinsha River stations and five Chattahoochee gauges. In the fitting records, Batang, Shigu, and four Chattahoochee sites are donor-dominated, whereas dam-proximal Panzhihua and the gauge immediately below Buford Dam are memory-dominated from 14- to 90-day horizons. Those labels are descriptive: dam proximity is aliased with network endpoints and donor direction, and the Jinsha daily files lack per-value quality codes or proof that temperatures were never interpolated. The heuristic tracks internal best-envelope shape (correlations 0.72--0.95), but its magnitude is state-dependent and does not transfer. Chattahoochee type labels and predicted curves were frozen before 2023--2025 outcomes; fixed-model long-gap scores are a labelled post-hoc sensitivity, not preregistered confirmation. Overlap-aware audits show one hypothesis cluster and three evaluation years per Jinsha station, so Wilcoxon p-values and statistical-frontier confidence intervals are withheld. A 335-station United States panel does not support a standalone dam classifier. The frozen pooled leave-one-ecoregion-out AUC of 0.407 is a preregistered defective diagnostic; the valid post-hoc level is a mean within-fold AUC of 0.526, with a region-dependent direction. The calculation is therefore a reproducible case-study screen, not a confirmatory prediction that reservoir structure generally determines recoverability.
...
Reservoir operation provides a physical reason for that distinction. Release depth, discharge, and storage state alter downstream seasonal amplitude and timing [@michie2020releases; @michel2023discharge], process-based regulated-river models now require high-frequency in situ temperature and explicit heat-flux terms [@dorthe2025regulated], and longitudinal observations show that thermal effects can attenuate or lag downstream [@zhao2020danjiangkou; @liu2025wudongde; @yang2025xiluodu]. Regional stream-air indicators can already identify dam-like thermal signatures without a dam map [@seyedhashemi2021thermalsignatures]. Our novelty is therefore not dam detection, a new heat budget, or a state-of-the-art imputer. We ask whether a train-only covariance heuristic can screen which information sources remain useful when observations are removed, and where that screen fails.
...
We froze the heuristic at three Jinsha stations, evaluated structured 2018--2020 outages, and added explicitly post-hoc stationarity controls without altering that prediction. We then evaluated a five-site 2023--2025 Chattahoochee panel beginning below Buford Dam, using a fixed model chosen only from 2021--2022 validation placements. Finally, an independently frozen United States panel tested the geographic boundary. The design is an observational case-study screen across two detailed networks plus a national diagnostic, not a causal reservoir experiment, a topology-matched confirmation, or a claim that one imputation model is generally best.
...
Training seeds were averaged before inference. Frontier curves use 2,000 joint cross-gap resamples stratified by station and anchor year, with connected overlap components retained as blocks. The only admissible hypothesis unit is an overlap component or site-year cluster. Each Jinsha station has one overlap component and three evaluation years, which is below the predeclared floor of five independent clusters. Wilcoxon p-values, Benjamini--Hochberg decisions, and statistical-frontier confidence intervals are therefore withheld. Climatology self-comparisons remain `reference_not_tested`. Descriptive skill and MAE curves are retained. The earlier $10^{-6}$ p-values treated 19--20 overlapping anchors as independent samples and are not used.
...
where $\widehat m_{-y,j}$ is selected without year $y$. We aggregate four gap lengths. Because only three evaluation years are available, bootstrap confidence intervals are withheld. Because selection folds are drawn from development evaluation after the original analysis, this is an explicitly post-hoc, non-oracle sensitivity rather than independent confirmation. The former event-wise best envelope is retained only in Supporting Information.
...
The primary predictor was the pre-existing memory--range index. The frozen primary analysis was unadjusted logistic regression with HC1 uncertainty plus leave-one-aggregated-ecoregion-out ROC AUC and 2,000 ecoregion-cluster bootstrap draws. Pooled leave-one-ecoregion-out AUC is the frozen primary generalization metric and is now labelled a preregistered defective diagnostic; an AUC near 0.5 does not reopen the freeze. The valid post-hoc discrimination summary is the mean of defined within-fold AUCs. A drainage-area/ecoregion-adjusted coefficient and a regulated-site profile in 0--5, 5--20, 20--50, 50--100, and greater than 100 km nearest-major-dam bins were sensitivities; no threshold was selected.
...
The frozen donor $R^2$ was 0.464 at B1, 0.470 at S2, and 0.106 at P3. Best-envelope correlations with the predicted curve were 0.72, 0.94, and 0.95; mean absolute skill errors were 0.077, 0.085, and 0.122 (Figure 3). The best model exceeded the point heuristic in 20 of 45 cells. A historical count of nine lower confidence bounds exceeding the heuristic, all at P3, is retained only as an audit of the old interval construction; those bounds are withheld because each station has fewer than five independent clusters. These results support qualitative shape screening at B1/S2 but reject the original interpretation as a universal ceiling.
...
State control strongly changed the P3 conclusion. Re-scoring against a 2016--2020 climatology left the historical lower-bound audit count at one instead of nine; those bounds remain withheld. At 365 days, XGBoost changed from skill 0.209 against the old climatology to -0.588 against the state-matched climatology, while the recalibrated heuristic was 0.069. Annual demeaning was less decisive: P3 XGBoost retained skill 0.164 at 365 days. Thus the sustained offset explains much of the apparent long-gap advantage, but within-year structure also remains recoverable.
...
Using the single corrected frontier path, descriptive right-censoring at 365 days occurred for random forest and XGBoost at B1 and S2 and for XGBoost at P3. Interpolation/Kalman point-frontier crossings occurred at 7.0--8.8 days at B1, 21.2--22.7 days at S2, and 93.1--160.0 days at P3. These are descriptive curve summaries, not confirmatory statistical frontiers. No p-value or confidence interval is reported for the 24 model-versus-climatology contrasts because each station supplies fewer than five independent clusters. Mean skills remain useful as ordered descriptions: random forest and XGBoost were positive at B1; donor regression, random forest, and XGBoost were positive at S2; and Kalman and XGBoost were positive at P3. They do not support a significance ranking.

### 3.4 Donor value reflects shared forcing; cross-fitted costs are modest

Observed same-day donor information exceeded the station-identity permutation by 0.057 skill across 60 paired units. Gain persisted under identity permutation and implausible lags, triggering the preregistered `falsified_network_propagation` decision. Synchronous stations therefore carry shared climatic or regulation information, but the experiment does not identify downstream heat transport. The paired-unit p-value is not treated as independent-sample confirmation.

The cross-fitted estimator changed both magnitude and interpretation (Figure 5; Table 5). Averaged over four gap lengths, losing S2 increased B1 MAE by 0.105 degrees C. B1 and P3 losses changed B1 MAE by -0.023 and -0.013 degrees C. For P3 recovery, B1 and S2 losses increased MAE by 0.058 and 0.054 degrees C. These 80 nested gap/anchor events occupy only three evaluation years, so bootstrap intervals are withheld. The values are post-hoc policy sensitivities, not causal station values, confirmatory intervals, or a protection ranking.

### 3.5 Held-out long-gap scores follow the type order in one post-hoc evaluation, but magnitude does not

Mean performance over the 2021--2022 validation placements selected XGBoost at all five sites before that rule was scored in 2023--2025 (Figure 6). The rule was written after the confirmatory envelope had been seen, so the scores are a labelled post-hoc sensitivity. At site 02334430 below Buford Dam, XGBoost skill was -0.209, -0.380, and -0.300 at 30, 90, and 180 days. The four donor-dominated sites retained 180-day skill of 0.726, 0.555, 0.746, and 0.724. The memory-site type label is also close to the 90-day threshold (margin $-0.031$). These numbers do not enter the abstract or conclusions as confirmatory evidence.
...
The heuristic predicted 0.414 skill at 180 days for 02334430 but the selected fixed model achieved -0.300. Exact magnitudes therefore did not transfer. The external result is a post-hoc type-order sensitivity in one temporal/network evaluation, not a universal frontier or a causal regulation effect.

### 3.6 National panel supports a distance gradient, not a standalone classifier

The frozen national flow discovered 5,707 temperature series, found 1,361 exact GAGES-II station overlaps and 1,344 stream sites, and retained 335 eligible stations (209 with and 126 without an upstream major dam). The primary unadjusted association was positive but uncertain: odds ratio 1.23 per index SD (95% CI 0.93--1.61; $p=0.144$). The frozen primary pooled leave-one-ecoregion-out AUC was 0.407 (ecoregion-cluster bootstrap interval 0.222--0.515). That number remains the frozen primary, but it is a defective discrimination metric: it scores fold intercept and base-rate mismatch as (anti)discrimination. Figure 7 therefore reports the fold-comparable diagnosis, not the defective ROC, as the visual headline. The index alone did not generalize as a national major-dam classifier.
...
The frozen sensitivities retain a localized descriptive signal. After drainage-area and ecoregion adjustment, the uncorrected index odds ratio was 2.52, but complete separation in a single-class Alaska ecoregion makes that coefficient and the exploding ecoregion odds ratios unreportable; they are suppressed in Table S7. A Firth unadjusted fit remains consistent with the primary null. Among regulated watersheds, median memory--range index declined from 0.0110 for 83 stations within 5 km of a major dam to 0.00690 at 5--20 km, 0.00611 at 20--50 km, and 0.00463 at 50--100 km; median acf30 declined from 0.262 to 0.135. The greater-than-100-km bin had one station and was not interpreted. A 62-station common-period coverage subset is reported only as a sensitivity. Case-study direction and the regulated-site distance profile agree descriptively, while valid cross-ecoregion binary discrimination does not.

## 4. Discussion

### 4.1 Case-study covariance structure is not an identified reservoir mechanism

The two networks show the same association: the dam-proximal station combines compressed seasonal range, extended persistence, and a memory-dominated label. Downstream of Buford, range increases and acf30 declines. This direction agrees with observations that release depth, discharge, and storage change downstream thermal amplitude [@michie2020releases; @michel2023discharge], that dam effects attenuate or lag longitudinally [@zhao2020danjiangkou; @liu2025wudongde; @yang2025xiluodu], and that regional stream-air indicators can recover dam-like thermal signatures [@seyedhashemi2021thermalsignatures]. It does not identify a reservoir mechanism. In both networks the memory-dominated site is also a network endpoint, and donor geometry is one-sided. Recent regulated-river studies with logger-grade, high-frequency observations and process heat fluxes [@dorthe2025regulated] remain a stronger design for thermal mechanism. Our additional result is only that a train-only covariance heuristic can label those two sites before model fitting. The observational design does not show that regulation alone caused either covariance pattern.
...
The national panel bounds the generality of the screen. The monotone 0--100-km profile is consistent with, but does not identify, downstream thermal re-equilibration. The frozen primary pooled leave-one-ecoregion-out AUC of 0.407 is a metric defect: pooling fold-calibrated probabilities across ecoregions whose dam rates range from 0 to 0.95 scores intercept mismatch as (anti)discrimination. A post-hoc within-fold diagnosis still finds no national skill (mean AUC 0.526). The informative result of that diagnosis is region-dependent direction, including a reversal in the Southeast Plains. Climate, channel scale, groundwater and sluggish-flow regimes, release depth, dam operation, and network placement can produce overlapping covariance signatures. Adjusted coefficients that rely on complete separation are not reported.

### 4.2 What remains of the covariance heuristic

The original ceiling language was too strong. The historical lower-bound exceedances occurred where calibration and evaluation crossed a thermal transition, and they are not used as inference. Once the denominator and heuristic were matched to the later state, almost all of that audit count disappeared, yet annual demeaning left positive long-gap skill beyond the original prediction. The additive donor-plus-memory form is not an orthogonal variance decomposition, and its MAE conversion requires empirical calibration. It is useful as a qualitative screening curve and stable type label, not as an information-theoretic bound.

### 4.3 Monitoring-network consequences

The cross-fitted analysis and the case-study error scale give only a limited planning sketch. In degrees C rather than skill:

1. Losing S2 raises B1 reconstruction MAE by 0.105 degrees C as a descriptive three-year mean; no confidence interval is reported.
2. At the two memory-labelled reaches, boundary observations matter more than a distant donor in these networks, but that is not a general protection rule.
3. Typical model gains are tenths of a degree against climatology MAE of about 0.65--1.35 degrees C; no ecological safety threshold was declared.
4. Thermal state changes can invert long-gap skill interpretations (P3 365-day XGBoost 0.209 to $-0.588$ under state-matched climatology).

These values depend on the three-station roster and post-hoc cross-fitting population. They do not justify station removal, sensor-protection policy, or a safe-fill length.
...
A train-only covariance heuristic labels dam-proximal stations as memory-dominated in two case-study networks. That association is reproducible as a descriptive screen and is not a confirmatory demonstration that reservoir-associated structure predicts recoverability. Dam proximity is aliased with network topology; Jinsha source quality is incomplete; overlap-aware inference withholds p-values and confidence intervals; the Chattahoochee fixed-model scores are post-hoc; and the frozen national pooled AUC of 0.407 is a defective diagnostic. The valid post-hoc national level is a mean within-fold AUC of 0.526, still with no national skill and a region-dependent direction that includes a Southeast Plains reversal. The honest claim is therefore narrower: covariance structure can help inspect monitoring vulnerability in a documented network after local calibration. It does not support a general dam-protection rule, a causal thermal-re-equilibration mechanism, or a WRR-scale confirmatory title.
...
## Table 1
| network                     | station_id   | station_name                                       | recoverability_type   |   donor_component |   memory_component |   type_margin | near_classification_threshold   |   acf30 |   training_observed_range_degC |   memory_range_index_per_degC | dam_distance_km   | regulation_context                |
|:----------------------------|:-------------|:---------------------------------------------------|:----------------------|------------------:|-------------------:|--------------:|:--------------------------------|--------:|-------------------------------:|------------------------------:|:------------------|:----------------------------------|
| Upper Jinsha                | B1           | Batang                                             | donor_dominated       |             0.464 |              0.058 |         0.406 | False                           |   0.131 |                           20.5 |                         0.006 | undefined         | upstream of Guanyinyan            |
| Upper Jinsha                | S2           | Shigu                                              | donor_dominated       |             0.47  |              0.079 |         0.391 | False                           |   0.141 |                           16.5 |                         0.009 | undefined         | upstream of Guanyinyan            |
| Upper Jinsha                | P3           | Panzhihua                                          | memory_dominated      |             0.106 |              0.553 |        -0.447 | False                           |   0.59  |                           14.5 |                         0.041 | 27.0              | 27 km downstream of Guanyinyan    |
| Upper--Middle Chattahoochee | 02334430     | CHATTAHOOCHEE RIVER AT BUFORD DAM, NEAR BUFORD, GA | memory_dominated      |             0.367 |              0.507 |        -0.14  | False                           |   0.762 |                            9.9 |                         0.077 | 0.366             | 0.366 km below Buford Dam         |
| Upper--Middle Chattahoochee | 02335000     | CHATTAHOOCHEE RIVER NEAR NORCROSS, GA              | donor_dominated       |             0.853 |              0.043 |         0.81  | False                           |   0.397 |                           14.8 |                         0.027 | 21.432            | downstream re-equilibration reach |
| Upper--Middle Chattahoochee | 02335450     | CHATTAHOOCHEE RIVER ABOVE ROSWELL, GA              | donor_dominated       |             0.913 |              0.027 |         0.886 | False                           |   0.377 |                           18   |                         0.021 | 29.325            | downstream re-equilibration reach |
| Upper--Middle Chattahoochee | 02336000     | CHATTAHOOCHEE RIVER AT ATLANTA, GA                 | donor_dominated       |             0.925 |              0.019 |         0.905 | False                           |   0.304 |                           23.7 |                         0.013 | 48.279            | downstream re-equilibration reach |
| Upper--Middle Chattahoochee | 02337170     | CHATTAHOOCHEE RIVER NEAR FAIRBURN, GA              | donor_dominated       |             0.868 |              0.031 |         0.837 | False                           |   0.281 |                           24   |                         0.012 | 78.521            | downstream re-equilibration reach |
...
## Table 4
| station_id   |   gap_length | validation_selected_model   |   validation_mean_MAE |   mean_skill |   mean_MAE_degC |   mean_climatology_MAE_degC |   n_anchors |   n_independent_clusters | hypothesis_status                          |
|:-------------|-------------:|:----------------------------|----------------------:|-------------:|----------------:|----------------------------:|------------:|-------------------------:|:-------------------------------------------|
| B1           |           30 | xgboost                     |                 0.446 |        0.194 |           0.517 |                       0.757 |          20 |                        1 | withheld_insufficient_independent_clusters |
| B1           |           90 | xgboost                     |                 0.446 |        0.198 |           0.502 |                       0.699 |          20 |                        1 | withheld_insufficient_independent_clusters |
| B1           |          180 | xgboost                     |                 0.446 |        0.225 |           0.518 |                       0.718 |          20 |                        1 | withheld_insufficient_independent_clusters |
| P3           |           30 | kalman                      |                 0.458 |        0.58  |           0.364 |                       1.306 |          20 |                        1 | withheld_insufficient_independent_clusters |
| P3           |           90 | kalman                      |                 0.458 |        0.479 |           0.48  |                       1.296 |          20 |                        1 | withheld_insufficient_independent_clusters |
| P3           |          180 | kalman                      |                 0.458 |       -0.045 |           1.119 |                       1.218 |          20 |                        1 | withheld_insufficient_independent_clusters |
| S2           |           30 | donor_regression            |                 0.357 |        0.183 |           0.539 |                       0.674 |          20 |                        1 | withheld_insufficient_independent_clusters |
| S2           |           90 | donor_regression            |                 0.357 |        0.173 |           0.552 |                       0.674 |          20 |                        1 | withheld_insufficient_independent_clusters |
| S2           |          180 | donor_regression            |                 0.357 |        0.183 |           0.539 |                       0.651 |          20 |                        1 | withheld_insufficient_independent_clusters |
...
## Table 5
| experiment   | mask_type       | layout             | outage_mode   | overlap_ratio   | pattern   |   window_length | training_protocol   | fit_split   | tuning_split   | evaluation_split   | validation_scope       | target_station_id   | station_id   | target   | model               | failed_station_id   |   full_network_value |   failed_value |   impact | impact_ci_lower   | impact_ci_upper   | value_metric   | impact_definition                                        | selection_population             | evidence_role                   | formal_evidence   | eventwise_oracle_selection   | full_network_selected_model_counts                                | failed_selected_model_counts                                        |   n_gap_lengths |   n_anchor_years |   n_events | reason    |   n_independent_clusters |   minimum_independent_clusters | inference_status                           | inference_claim_allowed   | inference_reason                                                                           |
|:-------------|:----------------|:-------------------|:--------------|:----------------|:----------|----------------:|:--------------------|:------------|:---------------|:-------------------|:-----------------------|:--------------------|:-------------|:---------|:--------------------|:--------------------|---------------------:|---------------:|---------:|:------------------|:------------------|:---------------|:---------------------------------------------------------|:---------------------------------|:--------------------------------|:------------------|:-----------------------------|:------------------------------------------------------------------|:--------------------------------------------------------------------|----------------:|-----------------:|-----------:|:----------|-------------------------:|-------------------------------:|:-------------------------------------------|:--------------------------|:-------------------------------------------------------------------------------------------|
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | B1                  | B1           | T        | cross_fitted_policy | B1                  |                0.52  |          0.497 |   -0.023 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":30,"pchip":10,"random_forest":32,"xgboost":8} | {"pchip":10,"random_forest":46,"xgboost":24}                        |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | B1                  | B1           | T        | cross_fitted_policy | P3                  |                0.52  |          0.507 |   -0.013 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":30,"pchip":10,"random_forest":32,"xgboost":8} | {"donor_regression":70,"pchip":10}                                  |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | B1                  | B1           | T        | cross_fitted_policy | S2                  |                0.52  |          0.625 |    0.105 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":30,"pchip":10,"random_forest":32,"xgboost":8} | {"air_only":38,"climatology":10,"kalman":10,"linear":12,"pchip":10} |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | P3                  | P3           | T        | cross_fitted_policy | B1                  |                0.489 |          0.547 |    0.058 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"kalman":54,"linear":6,"xgboost":20}                             | {"donor_regression":12,"kalman":62,"linear":6}                      |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | P3                  | P3           | T        | cross_fitted_policy | P3                  |                0.489 |          0.5   |    0.011 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"kalman":54,"linear":6,"xgboost":20}                             | {"kalman":54,"linear":6,"xgboost":20}                               |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | P3                  | P3           | T        | cross_fitted_policy | S2                  |                0.489 |          0.543 |    0.054 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"kalman":54,"linear":6,"xgboost":20}                             | {"air_only":12,"kalman":62,"linear":6}                              |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | S2                  | S2           | T        | cross_fitted_policy | B1                  |                0.487 |          0.51  |    0.023 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":10,"kalman":4,"pchip":20,"xgboost":46}        | {"air_hydro":29,"climatology":11,"kalman":20,"pchip":20}            |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | S2                  | S2           | T        | cross_fitted_policy | P3                  |                0.487 |          0.482 |   -0.005 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":10,"kalman":4,"pchip":20,"xgboost":46}        | {"kalman":20,"pchip":20,"random_forest":8,"xgboost":32}             |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
| SCI_NET      | matched_network | matched_target_gap | hydro-only    | undefined       | T         |             368 | seen_length         | train       | validation     | development_test   | development_evaluation | S2                  | S2           | T        | cross_fitted_policy | S2                  |                0.487 |          0.494 |    0.007 | undefined         | undefined         | MAE            | leave_one_anchor_year_out_cross_fitted_failed_minus_full | development_evaluation_cross_fit | post_hoc_non_oracle_sensitivity | False             | False                        | {"donor_regression":10,"kalman":4,"pchip":20,"xgboost":46}        | {"donor_regression":15,"kalman":15,"pchip":20,"random_forest":30}   |               4 |                3 |         80 | undefined |                        3 |                              5 | withheld_insufficient_independent_clusters | False                     | year/overlap clusters below the predeclared floor; point estimates remain descriptive only |
