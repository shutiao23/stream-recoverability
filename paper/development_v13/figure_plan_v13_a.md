# Figure plan v13 (agent a): five main figures and supporting displays
...
planned `results/revision_v13/decision_harmonization/agent_a/` (full coverage–regret
curves for every comparator, network-coverage variant, floor annotations).
